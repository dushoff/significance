...
\jd{Why does Morgan cite Kramer?}
\bmb{perhaps [IIRC] because it was an indirect ref?}
\citet{Kramer2011}.
...
In other cases (e.g., testing the overall effect of a categorical predictor with more than two levels), it may not be simple to describe the difference, but NHST is still a reasonable, accepted way to evaluate whether an effect has been seen clearly.
