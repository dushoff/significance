...
The value of NHST can be seen in something like a permutation-based t-test \cite{GoodBook}: it provides a simple, robust framework to ask whether we can tell \emph{which} mean is bigger. 
