...
\bmb{would be good to have a citation here; do any of the ``best practices''/NHST criticisms bring up N-I tests? If not, is there a good intro reference?}
