...
We agree about that these practices would be stronger if they were institutionalized, and hope to head in this direction. Publishing the idea is, we hope, a first step. We have found through informal discussion that there is little confusion when our recommended *qualitative* statements about statistical clarity are combined with *quantitative* information about p-values or confidence intervals. We have made this point more explicit in the MS. 
